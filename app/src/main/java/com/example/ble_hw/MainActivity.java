...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList<com.example.ble_hw.ScannedData> findDevice = new ArrayList<>();
    ...
    private void bluetoothScan() {
        ...
        isScanning=false;
        /**製作停止/開始掃描的按鈕*/
        final Button btScan = findViewById(R.id.btn_scan);
        ...
        public void onLeScan(BluetoothDevice device, int rssi, byte[] scanRecord) {
            new Thread(()->{
                ...
                if (device.getName()!= null){
                    /**將搜尋到的裝置加入陣列*/
                    findDevice.add(new com.example.ble_hw.ScannedData(device.getName()
                            , String.valueOf(rssi)
