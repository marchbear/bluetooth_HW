...
class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    private List<com.example.ble_hw.ScannedData> arrayList = new ArrayList<>();
    ...
    /**若有不重複的裝置出現，則加入列表中*/
    public void addDevice(List<com.example.ble_hw.ScannedData> arrayList){
    ...
    interface OnItemClick{
        void onItemClick(com.example.ble_hw.ScannedData selectedDevice);
    }
